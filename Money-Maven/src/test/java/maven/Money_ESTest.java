...
public class Money_ESTest extends Money_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Money money1 = new Money(1270, "");
      boolean boolean0 = money0.equals(money1);
      assertEquals(1270, money1.getAmount());
  ...
  public void test11()  throws Throwable  {
      Money money0 = new Money(262, "]g(hCpiBLN");
      Money money1 = new Money(262, "]g'hCpiELN");
  ...
  public void test12()  throws Throwable  {
      Money money0 = new Money(3549, "");
      Money money1 = money0.add(money0);
      boolean boolean0 = money1.equals(money0);
      assertFalse(boolean0);
      assertEquals(7098, money1.getAmount());
      assertEquals(3549, money0.getAmount());
